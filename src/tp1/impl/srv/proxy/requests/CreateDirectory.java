...
import tp1.impl.srv.proxy.arguments.CreateFolderV2Args;
...
public class CreateDirectory {
	...
	private static boolean execute(String directory) {
		...
		OAuth20Service service = new ServiceBuilder(ProxyRequest.apiKey).apiSecret(ProxyRequest.apiSecret).build(DropboxApi20.INSTANCE);
