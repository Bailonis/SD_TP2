...
public class UsersResource implements RestUsers {
	...
	public UsersResource(String domain, Discovery record) throws UnknownHostException {
	...
	public User deleteUser(String userId, String password) {
		...
		synchronized (this.users) {
			...
			this.deleteSpreadsheetsRest(userId);
	...
	@Override
	public List<User> hasUsers(String pattern) {
	...
	protected void deleteSpreadsheetsRest(String userId) {
