...
import tp1.server.resources.soap.SpreadsheetResourceSoap;

public class SpreadsheetServerSoap {
	...
	public static void main(String[] args) throws Exception {
		...
		record.start();
		Endpoint soapUsersEndpoint = Endpoint.create(new SpreadsheetResourceSoap(domain, record));
